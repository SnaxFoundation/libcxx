...
extern "C" void snax_assert(bool, const char*);
size_t strftime(char*, size_t, const char*, const struct tm*) { snax_assert(false, "strftime called"); }
size_t strftime_l(char*, size_t, const char*, const struct tm*, locale_t) { snax_assert(false, "strftime_l called"); }
